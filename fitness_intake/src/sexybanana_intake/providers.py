...
""",
    "plan": """Produce a fourteen-day candidate plan using ONLY the supplied allowed exercise IDs.
...
Output exactly the candidate schema; never include narrative fields or markdown.
""",
}
        ...
        for day in days:
            for block in day["blocks"]:
                if (
                    ...
                    block.update(sets=sets, repetitions=8, active_minutes=sets * 8 * 4 / 60)
        return {"days": days}
